...
CREATE TYPE "SSC"."MODIFICACION_TIPO" AS ENUM ('SUSPENSION', 'REINICIO', 'PRORROGA');
...
CREATE TABLE IF NOT EXISTS "SSC"."TBL_CONTRATOS" (
    ...
    "CON_NRO_CONTRATO" INTEGER UNIQUE NOT NULL,
...
-- Tabla CUO (Centro Único de Obra)
...
CREATE TABLE IF NOT EXISTS "SSC"."TBL_SEGUIMIENTOGENERAL" (
    ...
    "SEG_AVANCE_FINANCIERO" DECIMAL(5,2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS "SSC"."TBL_ADICIONES" (
    ...
    "ADI_VALOR_ADICION" DECIMAL(15,2) NOT NULL,
